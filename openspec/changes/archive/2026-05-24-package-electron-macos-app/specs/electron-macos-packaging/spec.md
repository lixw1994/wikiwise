...
The Electron packaging phase SHALL preserve the distinction between local unsigned app packaging and signed release distribution.
...
- **AND** it states that signed, notarized DMG release remains a separate release gate
