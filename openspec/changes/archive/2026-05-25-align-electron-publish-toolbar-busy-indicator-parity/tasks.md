...
- [x] 1.1 Add a publishing parity test proving the toolbar publish busy state has a native-sized inline indicator before the busy label.
- [x] 1.2 Run the targeted Electron publishing test and confirm the new test fails before implementation.

## 2. Renderer Busy Indicator

- [x] 2.1 Add stable publish button label and busy indicator markup, renderer toggling, and scoped spinner styling.
