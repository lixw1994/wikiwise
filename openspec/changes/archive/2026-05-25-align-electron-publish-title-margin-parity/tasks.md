...
- [x] 1.1 Add a publishing parity test that proves the native publish title uses the dialog gap without an extra title bottom margin.
- [x] 1.2 Run the targeted Electron publishing test and confirm the new test fails before implementation.

## 2. Renderer Styling

- [x] 2.1 Add a publish-dialog-scoped title margin reset without changing shared modal title spacing.
