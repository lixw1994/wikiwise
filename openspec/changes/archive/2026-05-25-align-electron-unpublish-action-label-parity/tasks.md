...
- [x] 1.1 Add a publishing parity test for the unpublish confirmation destructive action label.
...
- [x] 2.1 Keep the Electron confirmation destructive action text fixed at `Unpublish` while preserving the in-flight disabled state.
