...
- [x] 1.1 Add a failing Electron publishing test for native first-publish and update result copy.
- [x] 1.2 Verify the targeted Electron publishing test fails before implementation.

## 2. Publish Result Implementation

- [x] 2.1 Add renderer logic for native first-publish and update success messages.
- [x] 2.2 Hide or clear the duplicate standalone result URL while preserving the external-open behavior.
