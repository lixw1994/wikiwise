...
- [x] 1.1 Update the publishing parity test to require a static `Publish` confirmation action label.
...
- [x] 2.1 Keep the Electron publish dialog confirmation action text fixed at `Publish`.
