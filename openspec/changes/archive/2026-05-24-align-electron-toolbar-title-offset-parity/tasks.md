...
- [x] 1.1 Add source tests for native SwiftUI title offset reference and Electron CSS/renderer offset wiring.
- [x] 1.2 Add runtime-audit source tests for toolbar title offset evidence and failure messages.
- [x] 1.3 Run focused tests and confirm the new assertions fail before implementation.

## 2. Implementation

- [x] 2.1 Add CSS variable and transform for toolbar project title offset.
- [x] 2.2 Update renderer toolbar state to compute the native half-sidebar title offset.
- [x] 2.3 Update runtime audit to capture and assert title-offset evidence across left-sidebar hide/restore.
