...
- [x] 1.1 Add a publishing parity test proving the Electron publish URL row uses native zero item spacing.
- [x] 1.2 Run the targeted Electron publishing test and confirm the new test fails before implementation.

## 2. Renderer Styling

- [x] 2.1 Set the publish URL row gap to zero without changing grid columns or indicator dimensions.
