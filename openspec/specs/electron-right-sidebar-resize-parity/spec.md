# electron-right-sidebar-resize-parity Specification

## Purpose
Capture Electron parity for the native macOS right-sidebar resize interaction, including draggable width changes, min/max constraints, terminal refit behavior, and runtime audit evidence.
