...
- **WHEN** the packaged app cannot launch, cannot load the packaged renderer, cannot observe the packaged preload bridge, or is missing required packaged runtime files
