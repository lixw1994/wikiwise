...
The user is reading this wiki in the Wikiwise app, which watches the project directory for changes. When you edit `.md` or `.css` files, the app detects the change and automatically recompiles and refreshes the page the user is viewing.
