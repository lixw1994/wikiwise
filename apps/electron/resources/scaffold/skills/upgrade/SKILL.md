...
for f in files:
    name = f['filename']
    if name.startswith('apps/electron/resources/scaffold/') or name.startswith('apps/electron/resources/') and name.count('/') == 3:
        print(name)
"
```
...
```
https://raw.githubusercontent.com/TristanH/wikiwise/main/apps/electron/resources/scaffold/<path>
```

Build tooling (these live outside scaffold/ in Resources/):
```
https://raw.githubusercontent.com/TristanH/wikiwise/main/apps/electron/resources/build.js
https://raw.githubusercontent.com/TristanH/wikiwise/main/apps/electron/resources/style.css
https://raw.githubusercontent.com/TristanH/wikiwise/main/apps/electron/resources/app.js
https://raw.githubusercontent.com/TristanH/wikiwise/main/apps/electron/resources/graph.js
https://raw.githubusercontent.com/TristanH/wikiwise/main/apps/electron/resources/map.html
https://raw.githubusercontent.com/TristanH/wikiwise/main/apps/electron/resources/map-3d.html
https://raw.githubusercontent.com/TristanH/wikiwise/main/apps/electron/resources/markdown-it.min.js
```
